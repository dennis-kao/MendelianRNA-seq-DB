...
if __name__=="__main__":
	...
	parser.add_argument('-transcript_model',help="Transcript model of canonical splicing, e.g. gencode v19. Path set to /home/dennis.kao/largeWork/MendelianRNA-seq/gencode.comprehensive.splice.junctions.txt",action='store',default = "/home/dennis.kao/largeWork/MendelianRNA-seq/gencode.comprehensive.splice.junctions.txt")
